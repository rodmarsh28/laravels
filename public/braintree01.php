...
while (strpos($response, 'risk_threshold') && $r <= 5);
...
if (strpos($response, "Matched")){
    ...
    echo '<tr><td><span class="badge badge-dark badge-pill">'.$lista.'</span></td><td><span> => </span></td><td><span class="badge badge-danger badge-pill">"MESSAGE": CHECKING TIMEOUT / HOST IS DEAD - Retries: '.$retries.'</span></td><td><span class="badge badge-info badge-pill"> Took '.number_format(microtime(true) - $time_start, 2).' seconds</span></td></tr><br>';
}