...
echo $page =  cURL(
    "https://littlelemonboutique.com/my-account/",
    $headers = [
 ...
 $register_nonce = GetStr($page, 'name="woocommerce-register-nonce" value="', '"');
  ...
  $add_payment = cURL(
    ...
    $headers = [
        ...
        "referer: https://littlelemonboutique.com/my-account/",
        "User-Agent: Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:106.0) Gecko/20100101 Firefox/106.0"
    ],
...
$edit_address = cURL(
    'https://littlelemonboutique.com/my-account/edit-address/billing/',
    $headers = [
        "User-Agent: Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:106.0) Gecko/20100101 Firefox/106.0",
        "referer: https://littlelemonboutique.com/my-account/edit-address/",
        "Accept: text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,*/*;q=0.8"
    ],
    "",
    "GET",
 ...
 $prepare_pm = cURL(
    'https://littlelemonboutique.com/my-account/add-payment-method/',
    $headers = [
        "User-Agent: Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:106.0) Gecko/20100101 Firefox/106.0",
        "referer: https://littlelemonboutique.com/my-account/edit-address/billing/",
        "Accept: text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,*/*;q=0.8"
    ],
    "",
    "GET",
...
//   $ajax = cURL(
//     "https://littlelemonboutique.com/wp-admin/admin-ajax.php",
//     $headers = [
//         "accept: */*",
//         "content-type: application/x-www-form-urlencoded; charset=UTF-8",
//         "origin: https://littlelemonboutique.com",
//         "referer: https://littlelemonboutique.com/my-account/add-payment-method/",
